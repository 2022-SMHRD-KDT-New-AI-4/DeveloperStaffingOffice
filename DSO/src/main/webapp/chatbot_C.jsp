...
<body>
	...
	<script type="text/javascript">
		...
		$('#Ans_3').click(function(){ 
			...
			let ans3 = '<div class="outAnsBox"><div class="innerAnsbox">마이페이지에 있는 전문가와의<br>1:1 대화를 통해 결제를<br>진행할 수 있습니다.</div></div><br><br>';
			$('.ChatListbox').append(que);
		...
		$('#Ans_4').click(function(){ 
			...
			let que = '<div class="outerQue"><div class="innerQue">자고 싶나요?</div></div>';
			let ans4 = '<div class="outAnsBox"><div class="innerAnsbox">주<br>무<br>세<br>요</div></div><br><br>';
			$('.ChatListbox').append(que);
